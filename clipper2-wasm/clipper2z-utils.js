var Clipper2ZUtils = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      if (Module["locateFile"]) {
        var f = "clipper2z-utils.wasm";
        if (!isDataURI(f)) {
          return locateFile(f);
        }
        return f;
      }
      return new URL("clipper2z-utils.wasm", import.meta.url).href;
    }
    var wasmBinaryFile;
    ...
    var ___getTypeName = (a0) => (___getTypeName = wasmExports["F"])(a0);
    var _malloc = (a0) => (_malloc = wasmExports["H"])(a0);
