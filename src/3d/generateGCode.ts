...
function generateGCodeHeader(params: {
	...
	const primeSequence = doublePrime
		? [
				'M98 P"0:/sys/provel/prime.g" ; prime extruder (1 of 2)',
				"G4 S1 ; pause 1 second between primes",
				'M98 P"0:/sys/provel/prime.g" ; prime extruder (2 of 2)',
			]
...
export async function generateGCode(
	...
	const { estimatedTime = "0m 0s", doublePrime = false } = options;
